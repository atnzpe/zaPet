# main.py (Versão 1.0.1 - Estável e Polida)
...
def main(page: ft.Page):
    ...
    def build_home_view():
        ...
        image_controls = [
            ft.Image(
                key=str(i), src=img, fit=ft.ImageFit.COVER, border_radius=10, width=380
            )
        ...
        def go_next(e):
            if carousel_state["current_index"] < len(carousel_images_list) - 1:
                ...
                image_carousel.scroll_to(
                    key=str(carousel_state["current_index"]), duration=500
                )
                logging.info(
                    f"Carrossel avançou para o índice: {carousel_state['current_index']}"
                )
        ...
        def go_prev(e):
            if carousel_state["current_index"] > 0:
                ...
                logging.info(
                    f"Carrossel voltou para o índice: {carousel_state['current_index']}"
                )

        # --- CORREÇÃO FINAL: Posicionamento explícito dos botões ---
        carousel_with_buttons = ft.Stack(
            [
                ...
                ft.Container(
                    ...
                    # Posição explícita na borda esquerda
                    left=5,
                    top=0,
                    bottom=0,
                ...
                ft.Container(
                    ...
                    # Posição explícita na borda direita
                    right=5,
                    top=0,
                    bottom=0,
                    alignment=ft.alignment.center,
        ...
        def saber_mais_click(e):
            logging.info("Botão 'Saber mais' clicado.")
            page.snack_bar = ft.SnackBar(
                ft.Text("Mais informações em breve!"), open=True
            )
            page.update()
                                    ...
                                    ft.Container(
                                        ...
                                        content=ft.Column(
                                            [
                                                ...
                                                ft.Text("Eu amo a Zapet!...", size=20),
                                            ]
                                        ),
                                    ),
                                    ft.Container(
                                        ...
                                        content=ft.Column(
                                            [
                                                ...
                                                ft.Text(
                                                    "O melhor preço de ração é aqui!...",
                                                    size=20,
                                                ),
                                            ]
                                        ),
