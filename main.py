        ...
        banner = ft.Container(
            ...
            content=ft.Row(
                ...
                controls=[
                    ...
                    # CORREÇÃO no caminho do asset, para corresponder à pasta 'assets'
                    ft.Image(src="assets/logo.png", width=350, height=350),
                ],
            ),
        )

        carousel_images = [
            "assets/consultavet.jpg",
            "assets/hotel.jpg",
            "assets/Post_banho_e_tosa.jpg",
            "assets/farmacia.png",
            "assets/walker.jpeg",
            "assets/recep.jpg",
        ]
            ...
            content=ft.Column(
                ...
                controls=[
                    ...
                    ft.Row(
                        ...
                        controls=[
                            ft.Container(
                                bgcolor=COLOR_PRIMARY, padding=24, border_radius=25, width=400,
                                content=ft.Column([
                                    ft.Text("Joaquina disse:", size=22, weight=ft.FontWeight.W_700),
                                    ft.Text("22, Janeiro, 2024", size=18),
                                    ft.Text("Eu amo a Zapet! Sempre levo meu cachorrinho e somos muito bem atendidos. Especialmente por Dra. Maria, que é uma veterinária super competente e paciente.", size=20),
                                ])
                            ),
                            ft.Container(
                                bgcolor=COLOR_PRIMARY, padding=24, border_radius=25, width=400,
                                content=ft.Column([
                                    ft.Text("Alex disse:", size=22, weight=ft.FontWeight.W_700),
                                    ft.Text("26, Março 2024", size=18),
                                    ft.Text('O melhor preço de ração é aqui! Sempre encontro tudo que preciso na lojinha. Sem contar do hotelzinho, quando preciso viajar deixo meus "filhinhos" sem preocupações! A estrutura é excelente e o atendimento dos funcionários é maravilhoso! Super recomendo a Zapet!', size=20),
                                ])
                            ),
                        ],
                    ),
                ...
                ft.Container(
                    ...
                    content=ft.Column(
                        [
                            ...
                            # CORREÇÃO: 'text_transform' não existe. Use 'capitalization'.
                            ft.TextField(label="Nome", capitalization=ft.TextCapitalization.CHARACTERS),
                            ft.TextField(label="Email"),
                            ft.TextField(label="Mensagem", multiline=True, min_lines=4, max_lines=4),
                            ft.ElevatedButton("Enviar", width=200, style=ft.ButtonStyle(bgcolor=COLOR_PRIMARY, color="white")),
                        ]
                    ),
                )
            ],
...
# --- Inicia a aplicação ---
# CORREÇÃO: O diretório de assets foi corrigido para 'assets'
